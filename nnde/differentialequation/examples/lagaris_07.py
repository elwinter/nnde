"""
This module implements problem 7 in Lagaris et al (1998) (2nd order 2-D
nonlinear PDE BVP).
...
The analytical form of the equation is:
    ...
    d2Y_dx2 + d2Y_dy2 + Y*dY_dy
    - sin(pi*x)*(2 - pi**2*y**2 + 2*y**3*sin(pi*x))
    = 0
